...
__name(generateViewId, "generateViewId");
async function onRequestPost({ request, env }) {
  ...
  const tokenHash = await sha2562(editToken);
  await env.DB.prepare(
...
// ../.wrangler/tmp/pages-8jcuEj/functionsRoutes-0.40820430396370333.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-u6weOU/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-u6weOU/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7694006847492699.mjs.map
